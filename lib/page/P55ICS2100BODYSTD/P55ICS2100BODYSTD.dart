...
import '../page41.dart';
import '../page51.dart';
import 'P55ICS2100BODYSTDVAR.dart';

late BuildContext P55ICS2100BODYSTDcontext;

class P55ICS2100BODYSTD extends StatefulWidget {
  P55ICS2100BODYSTD({
    super.key,
    this.value,
    this.SET,
  ...
  @override
  State<P55ICS2100BODYSTD> createState() => _P55ICS2100BODYSTDState();
}

class _P55ICS2100BODYSTDState extends State<P55ICS2100BODYSTD> {
  @override
  void initState() {
    // TODO: implement initState
    super.initState();

    P55ICS2100BODYSTDVAR.value01 = '';
    P55ICS2100BODYSTDVAR.value02 = '';
    context.read<P55ICS2100BODYSTDGETSET_Bloc>().add(P55ICS2100BODYSTDGETSET_GET());
    context.read<GetICS2100value_Bloc>().add(GetICS2100value_Get());

    P55ICS2100BODYSTDVAR.D01VOLUME = '';
    P55ICS2100BODYSTDVAR.Result01 = '';
    P55ICS2100BODYSTDVAR.Result02 = '';
    P55ICS2100BODYSTDVAR.mem = 'GO';
    P55ICS2100BODYSTDVAR.WX = '';
  }

  @override
  Widget build(BuildContext context) {
    P55ICS2100BODYSTDcontext = context;

    print(P55ICS2100BODYSTDVAR.FluorideR1);

    P55ICS2100BODYSTDVAR.FluorideR1 = widget.value?.FluorideR1 ?? '';
    P55ICS2100BODYSTDVAR.FluorideR2 = widget.value?.FluorideR2 ?? '';

    P55ICS2100BODYSTDVAR.ChlorideR1 = widget.value?.ChlorideR1 ?? '';
    P55ICS2100BODYSTDVAR.ChlorideR2 = widget.value?.ChlorideR2 ?? '';

    P55ICS2100BODYSTDVAR.NitrateR1 = widget.value?.NitrateR1 ?? '';
    P55ICS2100BODYSTDVAR.NitrateR2 = widget.value?.NitrateR2 ?? '';

    P55ICS2100BODYSTDVAR.SulphateR1 = widget.value?.SulphateR1 ?? '';
    P55ICS2100BODYSTDVAR.SulphateR2 = widget.value?.SulphateR2 ?? '';

    P55ICS2100BODYSTDVAR.PhosphateR1 = widget.value?.PhosphateR1 ?? '';
    P55ICS2100BODYSTDVAR.PhosphateR2 = widget.value?.PhosphateR2 ?? '';

    P55ICS2100BODYSTDVAR.P2O7R1 = widget.value?.P2O7R1 ?? '';
    P55ICS2100BODYSTDVAR.P2O7R2 = widget.value?.P2O7R2 ?? '';

    P55ICS2100BODYSTDGETSETCLASS dataset = widget.SET ?? P55ICS2100BODYSTDGETSETCLASS();

    P55ICS2100BODYSTDVAR.ReqNo = dataset.ReqNo;
    P55ICS2100BODYSTDVAR.InstrumentName = dataset.InstrumentName;
    P55ICS2100BODYSTDVAR.CustFull = dataset.CustShort;
    P55ICS2100BODYSTDVAR.UID = dataset.UID;
    P55ICS2100BODYSTDVAR.ItemName = dataset.ItemName;
    P55ICS2100BODYSTDVAR.Mag = dataset.Mag;

    P55ICS2100BODYSTDVAR.D01W11 = dataset.D01W11;
    P55ICS2100BODYSTDVAR.D01W21 = dataset.D01W21;

    P55ICS2100BODYSTDVAR.SamplingDate = _monthreplce(dataset.SamplingDate);
    P55ICS2100BODYSTDVAR.DueDate1 = _monthreplce(dataset.DueDate1);
    P55ICS2100BODYSTDVAR.SampleName = dataset.SampleName;

    P55ICS2100BODYSTDVAR.itemName = dataset.ItemName;
    P55ICS2100BODYSTDVAR.RemarkNo = dataset.RemarkNo;
    P55ICS2100BODYSTDVAR.SampleCode = dataset.SampleCode;

    if (P55ICS2100BODYSTDVAR.D01VOLUME == '') {
    ...
    if (P55ICS2100BODYSTDVAR.D02VOLUME == '') {
      P55ICS2100BODYSTDVAR.iscontrol = true;
    ...
    // P55ICS2100BODYSTDVAR.Result = P55ICS2100BODYSTDVAR.W11;

    List<HistoryChartModel> _historyChartData = widget.historyChartDatain ?? [];
    // List<HistoryChartModel> _historyChartData = [];

    if (P55ICS2100BODYSTDVAR.mem == 'GO' &&
        P55ICS2100BODYSTDVAR.UID != '' &&
        P55ICS2100BODYSTDVAR.InstrumentName != '') {
      context.read<P55ICS2100BODYSTDgetgraph_Bloc>().add(P55ICS2100BODYSTDgetgraph_get());
      P55ICS2100BODYSTDVAR.mem = '';
    }
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        context.read<P55ICS2100BODYSTD_Bloc>().add(P55ICS2100BODYSTD_CLEARROOM());
                        CuPage = Page51();
                    ...
                    SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                            ...
                            child: Column(
                              children: [
                                Align(
                                  ...
                                  child: Text("REQ NO : ${P55ICS2100BODYSTDVAR.ReqNo}"),
                                ),
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("CustFull : ${P55ICS2100BODYSTDVAR.CustFull}"),
                                ),
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("Sample Type : ${P55ICS2100BODYSTDVAR.CustFull}"),
                                ),
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("Item Name : ${P55ICS2100BODYSTDVAR.itemName}"),
                                ),

                                //P55ICS2100BODYSTDVAR.itemName
                              ],
                            ),
                          ),
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              children: [
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("SAMPLING date : ${P55ICS2100BODYSTDVAR.SamplingDate}"),
                                ),
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("Due date : ${P55ICS2100BODYSTDVAR.DueDate1}"),
                                ),
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("Sampling Type : ${P55ICS2100BODYSTDVAR.SampleName}"),
                                ),
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("Position : ${P55ICS2100BODYSTDVAR.Mag}"),
                                ),
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("RemarkNo : ${P55ICS2100BODYSTDVAR.RemarkNo}"),
                                ),
                              ],
                            ),
                          ),
                          ...
                          //   children: [
                          //     Text(
                          //         "CustFull : ${P55ICS2100BODYSTDVAR.CustFull}"),
                          //   ],
                          // ),
                        ],
                      ),
                    ...
                    if (P55ICS2100BODYSTDVAR.itemName.contains("T-F"))
                      const SizedBox(
                        height: 15,
                      ),
                    if (P55ICS2100BODYSTDVAR.itemName.contains("T-F"))
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(P55ICS2100BODYSTDVAR.FluorideR1)),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(P55ICS2100BODYSTDVAR.FluorideR2)),
                                ),
                              ],
                            ),
                          ),
                    ...
                    if (P55ICS2100BODYSTDVAR.itemName.contains("Cl"))
                      const SizedBox(
                        height: 15,
                      ),
                    if (P55ICS2100BODYSTDVAR.itemName.contains("Cl"))
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(P55ICS2100BODYSTDVAR.ChlorideR1)),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(P55ICS2100BODYSTDVAR.ChlorideR2)),
                                ),
                              ],
                            ),
                          ),
                    ...
                    if (P55ICS2100BODYSTDVAR.itemName.contains("NO3"))
                      const SizedBox(
                        height: 15,
                      ),
                    if (P55ICS2100BODYSTDVAR.itemName.contains("NO3"))
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(P55ICS2100BODYSTDVAR.NitrateR1)),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(P55ICS2100BODYSTDVAR.NitrateR2)),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(P55ICS2100BODYSTDVAR.SulphateR1)),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(P55ICS2100BODYSTDVAR.SulphateR2)),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(P55ICS2100BODYSTDVAR.PhosphateR1)),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(P55ICS2100BODYSTDVAR.PhosphateR2)),
                                ),
                              ],
                            ),
                          ),
                    ...
                    if (P55ICS2100BODYSTDVAR.itemName == 'P2O7')
                      Row(
                        children: [
                          SizedBox(
                            height: 40,
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(P55ICS2100BODYSTDVAR.P2O7R1)),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(P55ICS2100BODYSTDVAR.P2O7R2)),
                                ),
                              ],
                            ),
                          ),
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              ...
                              //     .add(P55ICS2100BODYSTD_SETDATA());
                              context.read<GetICS2100value_Bloc>().add(GetICS2100value_Get());
                              context.read<P55ICS2100BODYSTD_Bloc>().add(P55ICS2100BODYSTD_SETDATA());
                              onLoadingFAKE(context);
                              Future.delayed(const Duration(milliseconds: 2000), () {
                                context
                                    .read<P55ICS2100BODYSTDGETSET_Bloc>()
                                    .add(P55ICS2100BODYSTDGETSET_GET());
                                setState(() {
                                  P55ICS2100BODYSTDVAR.WX = '';
                                });
                              });
                      ...
                      children: [
                        Column(
                          children: [
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        child: Container(
                                          height: 40,
                                          width: 80,
                                          color: P55ICS2100BODYSTDVAR.SEND == ''
                                              ? Colors.brown
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ComInputText(
                                                ...
                                                sValue: P55ICS2100BODYSTDVAR.D01NOitem,
                                                returnfunc: (String s) {
                                                  P55ICS2100BODYSTDVAR.D01NOitem = s;
                                                },
                                              ),
                                              Text("")
                                            ],
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        onTap: () {
                                          setState(() {
                                            P55ICS2100BODYSTDVAR.WX = 'D01W11';
                                          });
                                        ...
                                        child: Container(
                                          height: 40,
                                          width: 80,
                                          color: P55ICS2100BODYSTDVAR.WX == 'D01W11'
                                              ? Colors.yellowAccent
                                              : (P55ICS2100BODYSTDVAR.SEND == ''
                                                  ? Colors.green
                                                  : Colors.grey.shade400),
                                          child: const Center(
                                            child: Text("ANS #1"),
                                      ...
                                      Container(
                                        ...
                                        width: 100,
                                        color: Colors.blue,
                                        child: Center(child: Text(P55ICS2100BODYSTDVAR.D01W11)),
                                      ),
                                      const SizedBox(
                                        height: 5,
                                      ),
                                      InkWell(
                                        onTap: () {
                                          // P55ICS2100BODYSTDVAR.DX = 'D01W11';
                                          // onLoadingFAKE(context);
                                          // context
                                          //     .read<P55ICS2100BODYSTD_Bloc>()
                                          //     .add(P55ICS2100BODYSTD_CLEARW11());
                                          // Future.delayed(
                                          //     const Duration(
                                          //         milliseconds: 2000), () {
                                          //   context
                                          //       .read<
                                          //           P55ICS2100BODYSTDGETSET_Bloc>()
                                          //       .add(P55ICS2100BODYSTDGETSET_GET());
                            ...
                            //             child: Center(
                            //                 child:
                            //                     Text(P55ICS2100BODYSTDVAR.D01W11)),
                            //           ),
                            //           const SizedBox(
                            //             height: 5,
                            //           ),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ComInputText(
                                                ...
                                                sValue: P55ICS2100BODYSTDVAR.D02NOitem,
                                                returnfunc: (String s) {
                                                  P55ICS2100BODYSTDVAR.D02NOitem = s;
                                                },
                                              ),
                                              Text("")
                                            ],
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        onTap: () {
                                          setState(() {
                                            P55ICS2100BODYSTDVAR.WX = 'D02W11';
                                          });
                                        ...
                                        child: Container(
                                          height: 40,
                                          width: 80,
                                          color: P55ICS2100BODYSTDVAR.WX == 'D02W11'
                                              ? Colors.yellowAccent
                                              : (P55ICS2100BODYSTDVAR.SEND == ''
                                                  ? Colors.green
                                                  : Colors.grey.shade400),
                                      ...
                                      Container(
                                        ...
                                        width: 100,
                                        color: Colors.blue,
                                        child: Center(child: Text(P55ICS2100BODYSTDVAR.D02W11)),
                                      ),
                                      const SizedBox(
                                        height: 5,
                                      ),
                                      InkWell(
                                        onTap: () {
                                          // P55ICS2100BODYSTDVAR.DX = 'D02W11';
                                          // onLoadingFAKE(context);
                                          // context
                                          //     .read<P55ICS2100BODYSTD_Bloc>()
                                          //     .add(P55ICS2100BODYSTD_CLEARW11());
                    ...
                    // InkWell(
                    //   onTap: () {
                    //     // print(ConverstStr(P55ICS2100BODYSTDVAR.area));
                    //     if (P55ICS2100BODYSTDVAR.Result == '') {
                    //       setState(() {
                    //         P55ICS2100BODYSTDVAR.Result = ((double.parse(
                    //                         ConverstStr(
                    //                             P55ICS2100BODYSTDVAR.W11)) -
                    //                     double.parse(ConverstStr(
                    //                         P55ICS2100BODYSTDVAR.W12))) /
                    //                 double.parse(
                    //                     ConverstStr(P55ICS2100BODYSTDVAR.area)) *
                    //                 10000)
                    //             .toStringAsFixed(2);
                    //       });
                    //     } else {
                    ...
                    //     child: Center(
                    //       child: Text(
                    //         P55ICS2100BODYSTDVAR.Result == '' ? "CAL" : "RE CAL",
                    //         style: TextStyle(color: Colors.white),
                    //       ),
                    //     ),
                    //   ),
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        context.read<P55ICS2100BODYSTD_Bloc>().add(P55ICS2100BODYSTD_TEMP_SAVE());
                      },
                      child: Container(
                        height: 62,
                        color: Colors.orange,
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        //   context
                        //       .read<P55ICS2100BODYSTD_Bloc>()
                        //       .add(P55ICS2100BODYSTD_SEND_TO_SAR());
                        // }
                        // if (P55ICS2100BODYSTDVAR.area != '' &&
                        //     P55ICS2100BODYSTDVAR.W11 != '' &&
                        //     P55ICS2100BODYSTDVAR.W12 != '') {
                        // context
                        //     .read<P55ICS2100BODYSTD_Bloc>()
                        //     .add(P55ICS2100BODYSTD_Bloc_SEND_TO_SAR());
                        // } else {
                        //   WORNINGpop(
                        //     context,
                        //     [
                    ...
                    InkWell(
                      onTap: () {
                        // context
                        //     .read<P55ICS2100BODYSTD_Bloc>()
                        //     .add(P55ICS2100BODYSTD_CLEARROOM());
                        // CuPage = Page1();
                        // MainBodyContext.read<ChangePage_Bloc>()
                        //     .add(ChangePage_nodrower());
                      },
                      ...
                      children: <Widget>[
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: _LineChart(
                                  isShowingMainData: P55ICS2100BODYSTDVAR.isShowingMainData,
                        ...
                        IconButton(
                          icon: Icon(
                            Icons.refresh,
                            color:
                                Colors.white.withOpacity(P55ICS2100BODYSTDVAR.isShowingMainData ? 1.0 : 0.5),
                          ),
                          onPressed: () {
                            setState(() {
                              P55ICS2100BODYSTDVAR.isShowingMainData =
                                  !P55ICS2100BODYSTDVAR.isShowingMainData;
                            });
                          },
                        )
