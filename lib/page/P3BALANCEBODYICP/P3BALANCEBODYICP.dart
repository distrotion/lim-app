...
late BuildContext P3BALANCEBODYICPcontext;

class P3BALANCEBODYICP extends StatefulWidget {
  P3BALANCEBODYICP({
    super.key,
    this.value,
    this.SET,
  ...
  @override
  State<P3BALANCEBODYICP> createState() => _P3BALANCEBODYICPState();
}

class _P3BALANCEBODYICPState extends State<P3BALANCEBODYICP> {
  @override
  void initState() {
    ...
    P3BALANCEBODYICPVAR.Result01 = '';
    P3BALANCEBODYICPVAR.Result02 = '';
    P3BALANCEBODYICPVAR.mem = 'GO';
    P3BALANCEBODYICPVAR.WX = '';
  }

  @override
  Widget build(BuildContext context) {
    P3BALANCEBODYICPcontext = context;

    P3BALANCEBODYICPVAR.value = widget.value ?? '';
    P3BALANCEBODYICPGETSETCLASS dataset =
        widget.SET ?? P3BALANCEBODYICPGETSETCLASS();

    P3BALANCEBODYICPVAR.ReqNo = dataset.ReqNo;
    P3BALANCEBODYICPVAR.InstrumentName = dataset.InstrumentName;
    P3BALANCEBODYICPVAR.CustFull = dataset.CustShort;
    P3BALANCEBODYICPVAR.UID = dataset.UID;
    P3BALANCEBODYICPVAR.ItemName = dataset.ItemName;

    P3BALANCEBODYICPVAR.D01W11 = dataset.D01W11;
    P3BALANCEBODYICPVAR.D01W21 = dataset.D01W21;

    P3BALANCEBODYICPVAR.SamplingDate = _monthreplce(dataset.SamplingDate);
    P3BALANCEBODYICPVAR.DueDate1 = _monthreplce(dataset.DueDate1);
    P3BALANCEBODYICPVAR.SampleName = dataset.SampleName;

    P3BALANCEBODYICPVAR.itemName = dataset.ItemName;

    if (P3BALANCEBODYICPVAR.D01VOLUME == '') {
      P3BALANCEBODYICPVAR.iscontrol = true;
      P3BALANCEBODYICPVAR.D01VOLUME = dataset.D01VOLUME;
    }
    if (P3BALANCEBODYICPVAR.D01NOitem == '') {
      P3BALANCEBODYICPVAR.iscontrol = true;
      P3BALANCEBODYICPVAR.D01NOitem = dataset.D01NOitem;
    }
    P3BALANCEBODYICPVAR.D02W11 = dataset.D02W11;
    P3BALANCEBODYICPVAR.D02W21 = dataset.D02W21;
    if (P3BALANCEBODYICPVAR.D02VOLUME == '') {
      P3BALANCEBODYICPVAR.iscontrol = true;
      P3BALANCEBODYICPVAR.D02VOLUME = dataset.D02VOLUME;
    }
    if (P3BALANCEBODYICPVAR.D02NOitem == '') {
      P3BALANCEBODYICPVAR.iscontrol = true;
      P3BALANCEBODYICPVAR.D02NOitem = dataset.D02NOitem;
    }

    // P3BALANCEBODYICPVAR.Result = P3BALANCEBODYICPVAR.W11;

    List<HistoryChartModel> _historyChartData = widget.historyChartDatain ?? [];
    // List<HistoryChartModel> _historyChartData = [];

    if (P3BALANCEBODYICPVAR.mem == 'GO' &&
        P3BALANCEBODYICPVAR.UID != '' &&
        P3BALANCEBODYICPVAR.InstrumentName != '') {
      context
          .read<P3BALANCEBODYICPgetgraph_Bloc>()
          .add(P3BALANCEBODYICPgetgraph_get());
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        context
                            ...
                            .add(P3BALANCEBODYICP_CLEARROOM());
                        CuPage = Page1();
                            ...
                            child: Column(
                              children: [
                                Align(
                                  ...
                                  child: Text(
                                      "REQ NO : ${P3BALANCEBODYICPVAR.ReqNo}"),
                                ),
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text(
                                      "TYPE : ${P3BALANCEBODYICPVAR.InstrumentName}"),
                                ),
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text(
                                      "CustFull : ${P3BALANCEBODYICPVAR.CustFull}"),
                                ),
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text(
                            ...
                            child: Column(
                              children: [
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text(
                                      "SAMPLING date : ${P3BALANCEBODYICPVAR.SamplingDate}"),
                                ),
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text(
                                      "Due date : ${P3BALANCEBODYICPVAR.DueDate1}"),
                                ),
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text(
                                      "Sampling Name : ${P3BALANCEBODYICPVAR.SampleName}"),
                                ),
                              ],
                            ),
                          ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child:
                                Center(child: Text(P3BALANCEBODYICPVAR.value)),
                          ),
                          InkWell(
                            onTap: () {
                              //
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            //               height: 40,
                            //               width: 80,
                            //               color: P3BALANCEBODYICPVAR.SEND == ''
                            //                   ? Colors.brown
                            ...
                            //                   ComInputText(
                            //                     isNumberOnly: true,
                            //                     isEnabled: P3BALANCEBODYICPVAR
                            //                             .Result01 ==
                            //                         '',
                            //                     width: 100,
                            //                     height: 40,
                            //                     isContr: P3BALANCEBODYICPVAR
                            //                         .iscontrol,
                            //                     fnContr: (input) {
                            //                       setState(() {
                            //                         P3BALANCEBODYICPVAR
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        child: Container(
                                          height: 40,
                                          width: 80,
                                          color: P3BALANCEBODYICPVAR.WX ==
                                                  'D01W11'
                                              ? Colors.yellowAccent
                                              : (P3BALANCEBODYICPVAR.SEND == ''
                                                  ? Colors.green
                                                  : Colors.grey.shade400),
                                          child: const Center(
                                            child: Text("W1 (g)"),
                                      ...
                                      InkWell(
                                        onTap: () {
                                          ...
                                          Future.delayed(
                                            ...
                                            context
                                                .read<
                                                    P3BALANCEBODYICPGETSET_Bloc>()
                                                .add(
                                                    P3BALANCEBODYICPGETSET_GET());
                    ...
                    Row(
                      children: [
                        Expanded(
                          ...
                          child: Column(
                            children: [
                              if (P3BALANCEBODYICPVAR.dip12 != '') ...[
                                Container(
                                  height: 40,
                                  color: Colors.green,
                                  child: Center(
                                    child: Text(
                                      "dip 1-2 : " + P3BALANCEBODYICPVAR.dip12,
                                      style: TextStyle(color: Colors.white),
                                    ),
                                  ),
                                ),
                              ],
                              if (P3BALANCEBODYICPVAR.dip13 != '') ...[
                                Container(
                                  height: 40,
                                  color: Colors.green,
                                  child: Center(
                                    child: Text(
                                      "dip 1-3 : " + P3BALANCEBODYICPVAR.dip13,
                                      style: TextStyle(color: Colors.white),
                                    ),
                                  ),
                                ),
                                Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      "dip 2-3 : " + P3BALANCEBODYICPVAR.dip23,
                                      style: TextStyle(color: Colors.white),
                                    ),
                                  ),
                                ),
                        ...
                        Expanded(
                          ...
                          child: InkWell(
                            onTap: () {},
                            child: Container(
                              height: P3BALANCEBODYICPVAR.dip13 != ''
                                  ? 120
                                  : P3BALANCEBODYICPVAR.dip12 != ''
                                      ? 40
                                      : 0,
                              color: Colors.amber,
                              child: const Center(
                    ...
                    // InkWell(
                    //   onTap: () {
                    //     // print(ConverstStr(P3BALANCEBODYICPVAR.area));
                    //     if (P3BALANCEBODYICPVAR.Result == '') {
                    //       setState(() {
                    //         P3BALANCEBODYICPVAR.Result = ((double.parse(
                    //                         ConverstStr(
                    //                             P3BALANCEBODYICPVAR.W11)) -
                    //                     double.parse(ConverstStr(
                    //                         P3BALANCEBODYICPVAR.W12))) /
                    //                 double.parse(
                    //                     ConverstStr(P3BALANCEBODYICPVAR.area)) *
                    //                 10000)
                    //             .toStringAsFixed(2);
                    //       });
                    //     } else {
                    //       setState(() {
                    //         P3BALANCEBODYICPVAR.Result = '';
                    //       });
                    //     }
                    //   },
                    //   child: Container(
                    ...
                    //     child: Center(
                    //       child: Text(
                    //         P3BALANCEBODYICPVAR.Result == '' ? "CAL" : "RE CAL",
                    //         style: TextStyle(color: Colors.white),
                    //       ),
                    //     ),
                    //   ),
                    ...
                    //       //             width: 100,
                    //       //             height: 40,
                    //       //             isContr: P3BALANCEBODYICPVAR.iscontrol,
                    //       //             fnContr: (input) {
                    //       //               setState(() {
                    //       //                 P3BALANCEBODYICPVAR.iscontrol = input;
                    //       //               });
                    //       //             },
                    //       //             sValue: P3BALANCEBODYICPVAR.area,
                    //       //             returnfunc: (String s) {
                    //       //               P3BALANCEBODYICPVAR.area = s;
                    //       //             },
                    //       //           ),
                    //       //           Text("cm2")
                    //       //         ],
                    ...
                    //       child: InkWell(
                    //         onTap: () {
                    //           print(ConverstStr(P3BALANCEBODYICPVAR.D01VOLUME));
                    //           print(ConverstStr(P3BALANCEBODYICPVAR.D02VOLUME));
                    //           context
                    //               .read<P3BALANCEBODYICP_Bloc>()
                    //               .add(P3BALANCEBODYICP_CAL());
                    //           if (P3BALANCEBODYICPVAR.Result01 == '') {
                    //             setState(() {
                    //               if (P3BALANCEBODYICPVAR.D01W11 != '' &&
                    ...
                    //         child: Container(
                    //           height: 62,
                    //           color: P3BALANCEBODYICPVAR.Result01 == '' ||
                    //                   P3BALANCEBODYICPVAR.Result02 == ''
                    //               ? Colors.orange
                    //               : Colors.deepOrange,
                    //           child: Center(
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        context
                            .read<P3BALANCEBODYICP_Bloc>()
                            .add(P3BALANCEBODYICP_TEMP_SAVE());
                      },
                      child: Container(
                        height: 62,
                        color: Colors.orange,
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        //   context
                        //       .read<P3BALANCEBODYICP_Bloc>()
                        //       .add(P3BALANCEBODYICP_SEND_TO_SAR());
                        // }
                        // if (P3BALANCEBODYICPVAR.area != '' &&
                        //     P3BALANCEBODYICPVAR.W11 != '' &&
                        //     P3BALANCEBODYICPVAR.W12 != '') {
                        // context
                        //     .read<P3BALANCEBODYICP_Bloc>()
                        //     .add(P3BALANCEBODYICP_Bloc_SEND_TO_SAR());
                        // } else {
                        //   WORNINGpop(
                        //     context,
                        //     [
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              'ITEM : ${P3BALANCEBODYICPVAR.itemName}',
                              style: TextStyle(
                                fontSize: 15,
                                fontWeight: FontWeight.bold,
                                letterSpacing: 2,
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: _LineChart(
                                  isShowingMainData:
                                      P3BALANCEBODYICPVAR.isShowingMainData,
