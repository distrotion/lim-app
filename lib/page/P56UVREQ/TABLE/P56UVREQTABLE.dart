...
class P56UVREQTABLE extends StatefulWidget {
  P56UVREQTABLE({Key? key, this.sardata}) : super(key: key);
  List<dataset>? sardata;

  @override
  State<P56UVREQTABLE> createState() => _P56UVREQTABLEState();
}

class _P56UVREQTABLEState extends State<P56UVREQTABLE> {
  @override
  void initState() {
    super.initState();
  }
            ...
            child: Row(
              ...
              children: [
                ComInputText(
                  ...
                  height: 40,
                  width: 400,
                  isContr: P56UVREQVAR.iscontrol,
                  fnContr: (input) {
                    P56UVREQVAR.iscontrol = input;
                  },
                  sValue: P56UVREQVAR.SEARCH,
                  returnfunc: (String s) {
                    setState(() {
                      P56UVREQVAR.SEARCH = s;
                    });
                  },
                ),
                const Spacer(),
