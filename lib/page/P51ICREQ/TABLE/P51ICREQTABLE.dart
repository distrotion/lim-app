...
class P51ICREQTABLE extends StatefulWidget {
  P51ICREQTABLE({Key? key, this.sardata}) : super(key: key);
  List<dataset>? sardata;

  @override
  State<P51ICREQTABLE> createState() => _P51ICREQTABLEState();
}

class _P51ICREQTABLEState extends State<P51ICREQTABLE> {
  @override
  void initState() {
    super.initState();
  }
            ...
            child: Row(
              ...
              children: [
                ComInputText(
                  ...
                  height: 40,
                  width: 400,
                  isContr: P51ICREQVAR.iscontrol,
                  fnContr: (input) {
                    P51ICREQVAR.iscontrol = input;
                  },
                  sValue: P51ICREQVAR.SEARCH,
                  returnfunc: (String s) {
                    setState(() {
                      P51ICREQVAR.SEARCH = s;
                    });
                  },
                ),
                const Spacer(),
