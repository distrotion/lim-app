...
class P41WIDGETFIELD extends StatefulWidget {
  P41WIDGETFIELD({
    Key? key,
    this.height,
    this.SELECTFUNC,
  ...
  @override
  State<P41WIDGETFIELD> createState() => _P41WIDGETFIELDState();
}

class _P41WIDGETFIELDState extends State<P41WIDGETFIELD> {
  @override
