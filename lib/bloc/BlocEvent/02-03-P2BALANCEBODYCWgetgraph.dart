...
abstract class P2BALANCEBODYCWgetgraph_Event {}

class P2BALANCEBODYCWgetgraph_get extends P2BALANCEBODYCWgetgraph_Event {}

class P2BALANCEBODYCWgetgraph_flush extends P2BALANCEBODYCWgetgraph_Event {}

class P2BALANCEBODYCWgetgraph_Bloc
    extends Bloc<P2BALANCEBODYCWgetgraph_Event, List<HistoryChartModel>> {
  P2BALANCEBODYCWgetgraph_Bloc() : super([]) {
    on<P2BALANCEBODYCWgetgraph_get>((event, emit) {
      return _P2BALANCEBODYCWgetgraph_get([], emit);
    });
    on<P2BALANCEBODYCWgetgraph_flush>((event, emit) {
      return _P2BALANCEBODYCWgetgraph_flush([], emit);
    });
  }
  Future<void> _P2BALANCEBODYCWgetgraph_get(List<HistoryChartModel> toAdd,
  ...
  Future<void> _P2BALANCEBODYCWgetgraph_flush(List<HistoryChartModel> toAdd,
      Emitter<List<HistoryChartModel>> emit) async {
    List<HistoryChartModel> output = [];
    emit(output);
  }
