...
abstract class P32ICPBODYSTDgetgraph_Event {}

class P32ICPBODYSTDgetgraph_get extends P32ICPBODYSTDgetgraph_Event {}

class P32ICPBODYSTDgetgraph_flush extends P32ICPBODYSTDgetgraph_Event {}

class P32ICPBODYSTDgetgraph_Bloc
    extends Bloc<P32ICPBODYSTDgetgraph_Event, List<HistoryChartModel>> {
  P32ICPBODYSTDgetgraph_Bloc() : super([]) {
    on<P32ICPBODYSTDgetgraph_get>((event, emit) {
      return _P32ICPBODYSTDgetgraph_get([], emit);
    });
    on<P32ICPBODYSTDgetgraph_flush>((event, emit) {
      return _P32ICPBODYSTDgetgraph_flush([], emit);
    });
  }
  Future<void> _P32ICPBODYSTDgetgraph_get(List<HistoryChartModel> toAdd,
      Emitter<List<HistoryChartModel>> emit) async {
    List<HistoryChartModel> output = [];
    print("----------------------------");
    print(P32ICPBODYSTDVAR.UID);
    print(P32ICPBODYSTDVAR.ItemName);
    print("----------------------------");
    final response = await Dio().post(
      '${serverSARMAIN}/Widget_SearcHistoryChartData2',
      data: {
        'itemID': P32ICPBODYSTDVAR.UID,
  ...
  Future<void> _P32ICPBODYSTDgetgraph_flush(List<HistoryChartModel> toAdd,
      Emitter<List<HistoryChartModel>> emit) async {
    List<HistoryChartModel> output = [];
    emit(output);
  }
