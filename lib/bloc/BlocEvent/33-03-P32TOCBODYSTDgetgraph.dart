...
abstract class P33TOCBODYSTDgetgraph_Event {}

class P33TOCBODYSTDgetgraph_get extends P33TOCBODYSTDgetgraph_Event {}

class P33TOCBODYSTDgetgraph_flush extends P33TOCBODYSTDgetgraph_Event {}

class P33TOCBODYSTDgetgraph_Bloc
    extends Bloc<P33TOCBODYSTDgetgraph_Event, List<HistoryChartModel>> {
  P33TOCBODYSTDgetgraph_Bloc() : super([]) {
    on<P33TOCBODYSTDgetgraph_get>((event, emit) {
      return _P33TOCBODYSTDgetgraph_get([], emit);
    });
    on<P33TOCBODYSTDgetgraph_flush>((event, emit) {
      return _P33TOCBODYSTDgetgraph_flush([], emit);
    });
  }
  Future<void> _P33TOCBODYSTDgetgraph_get(List<HistoryChartModel> toAdd,
      Emitter<List<HistoryChartModel>> emit) async {
    List<HistoryChartModel> output = [];
    print("----------------------------");
    print(P33TOCBODYSTDVAR.UID);
    print(P33TOCBODYSTDVAR.ItemName);
    print("----------------------------");
    final response = await Dio().post(
      '${serverSARMAIN}/Widget_SearcHistoryChartData2',
      data: {
        'itemID': P33TOCBODYSTDVAR.UID,
  ...
  Future<void> _P33TOCBODYSTDgetgraph_flush(List<HistoryChartModel> toAdd,
      Emitter<List<HistoryChartModel>> emit) async {
    List<HistoryChartModel> output = [];
    emit(output);
  }
