...
abstract class P8BALANCEBODYSSMgetgraph_Event {}

class P8BALANCEBODYSSMgetgraph_get extends P8BALANCEBODYSSMgetgraph_Event {}

class P8BALANCEBODYSSMgetgraph_flush extends P8BALANCEBODYSSMgetgraph_Event {}

class P8BALANCEBODYSSMgetgraph_Bloc
    extends Bloc<P8BALANCEBODYSSMgetgraph_Event, List<HistoryChartModel>> {
  P8BALANCEBODYSSMgetgraph_Bloc() : super([]) {
    on<P8BALANCEBODYSSMgetgraph_get>((event, emit) {
      return _P8BALANCEBODYSSMgetgraph_get([], emit);
    });
    on<P8BALANCEBODYSSMgetgraph_flush>((event, emit) {
      return _P8BALANCEBODYSSMgetgraph_flush([], emit);
    });
  }
  Future<void> _P8BALANCEBODYSSMgetgraph_get(List<HistoryChartModel> toAdd,
      Emitter<List<HistoryChartModel>> emit) async {
    List<HistoryChartModel> output = [];
    print("----------------------------");
    print(P8BALANCEBODYSSMVAR.UID);
    print(P8BALANCEBODYSSMVAR.ItemName);
    print("----------------------------");
    final response = await Dio().post(
      '${serverSARMAIN}/Widget_SearcHistoryChartData2',
      data: {
        'itemID': P8BALANCEBODYSSMVAR.UID,
  ...
  Future<void> _P8BALANCEBODYSSMgetgraph_flush(List<HistoryChartModel> toAdd,
      Emitter<List<HistoryChartModel>> emit) async {
    List<HistoryChartModel> output = [];
    emit(output);
  }
